...
curl -sL "$REPO/ralph-review.sh" -o "$INSTALL_DIR/ralph-review$SUFFIX"
curl -sL "$REPO/ralph-review-auto.sh" -o "$INSTALL_DIR/ralph-review-auto$SUFFIX"
...
chmod +x "$INSTALL_DIR/ralph-review$SUFFIX"
chmod +x "$INSTALL_DIR/ralph-review-auto$SUFFIX"
...
echo -e "${GREEN}✓ Downloaded ralph-review$SUFFIX${NC}"
echo -e "${GREEN}✓ Downloaded ralph-review-auto$SUFFIX${NC}"
...
if [ "$LOCAL_INSTALL" = true ]; then
    ...
    echo "  ./ralph-review.sh     - Code review with interview (bugs, security, quality)"
    echo "  ./ralph-review-auto.sh - Automated code review (no interview)"
    echo ""
    ...
    echo "  ralph-review     - Code review with interview (bugs, security, quality)"
    echo "  ralph-review-auto - Automated code review (no interview)"
    echo ""
    echo -e "${YELLOW}Quick Start (new project):${NC}"
